...
export class __User_init_unchainedCall extends ethereum.Call {
  get inputs(): __User_init_unchainedCall__Inputs {
    return new __User_init_unchainedCall__Inputs(this);
  }

  get outputs(): __User_init_unchainedCall__Outputs {
    return new __User_init_unchainedCall__Outputs(this);
  }
}

export class __User_init_unchainedCall__Inputs {
  _call: __User_init_unchainedCall;

  constructor(call: __User_init_unchainedCall) {
    this._call = call;
  }
}

export class __User_init_unchainedCall__Outputs {
  _call: __User_init_unchainedCall;
